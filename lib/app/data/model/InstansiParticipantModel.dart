...
class InstansiPartipantModel {
  ...
  factory InstansiPartipantModel.fromRawJson(String str) =>
      InstansiPartipantModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory InstansiPartipantModel.fromJson(Map<String, dynamic> json) =>
      InstansiPartipantModel(
        id: json["id"] == null ? null : json["id"],
        activityId: json["activity_id"] == null ? null : json["activity_id"],
        organizationId:
            json["organization_id"] == null ? null : json["organization_id"],
        maxParticipant: json["max_participant"] == null
            ? null
            : int.parse(json["max_participant"].toString()),
        wilayahId: json["region_id"] == null
            ? null
            : int.parse(json["region_id"].toString()),
        wilayahName: json["region_name"],
        ...
        organization: json["organization"] == null
            ? null
            : InstansiModel.fromJson(json["organization"]),
      );
