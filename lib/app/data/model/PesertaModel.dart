...
class PesertaModel {
  ...
  factory PesertaModel.fromRawJson(String str) => PesertaModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory PesertaModel.fromJson(Map<String, dynamic> json) => PesertaModel(
    activityId: json["activity_id"] == null ? null : int.parse(json["activity_id"].toString()),
    ...
    kegiatan: json["kegiatan"] == null ? null : KegiatanModel.fromJson(json["kegiatan"]),
